            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2 space-y-4">
                    ...
                    <p className="text-[18px]  text-gray-600 ">
                        Step into the future of audio with our {product.name} — designed for comfort, convenience,
                        and exceptional sound quality. Whether you're commuting, working out, or simply enjoying your favorite tunes,
                        these wireless earphones provide the perfect blend of style and performance.
                    </p>
                    ...
                    <div>
                        <h3 className="text-[24px] font-semibold mb-2">Additional Features:</h3>
                        <ul className="text-[18px] list-disc pl-6 text-gray-700 space-y-1">
                ...
                <Card className="p-4 space-y-4 h-fit">
                    <h3 className=" text-[24px] font-semibold text-base">Customization Option</h3>
                    ...
                    <table className="min-w-full text-sm border border-gray-200 rounded-lg">
                        <thead>
                            <tr className="bg-gray-100">
                                <th className="py-2 px-4 text-left font-semibold border border-gray-300">Attribute</th>
                                <th className="py-2 px-4 text-left font-semibold border border-gray-300">Details</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y">
                            {Object.entries(product.productDetails.keyAttributes).map(([key, value], index) => (
                                <tr key={index}>
